...
var generateData = require('./routes/generateData');
var app = express();
...
app.post('/api/generateData', function(request, response) {

    console.log("Generate Data Invoked..");
//    console.log("Name: " + request.body.name);
//    console.log("Value: " + request.body.value);

    var spec = request.body;
    var responseString = "";
    console.log(spec);
    // var id = request.body.id;
    if (!spec.dataFile) {
        responseString = generateData();
    } else {
        responseString = generateData(spec);
    }
//    saveDocument(null, name, value, response);
